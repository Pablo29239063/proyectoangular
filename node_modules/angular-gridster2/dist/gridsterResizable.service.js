...
var GridsterResizable = (function () {
    ...
    GridsterResizable.prototype.handleW = function (e) {
        ...
        if (this.gridsterItem.$item.x !== this.newPosition) {
            ...
            if (this.gridster.checkCollision(this.gridsterItem.$item)) {
                ...
                this.gridsterItem.renderer.setElementStyle(this.gridsterItem.el, 'left', this.gridster.positionXToPixels(this.gridsterItem.$item.x) + 'px');
    ...
    GridsterResizable.prototype.dragStartDelay = function (e) {
        ...
        var cancelTouchEnd = this.gridsterItem.renderer.listenGlobal('document', 'touchend', cancelDrag);
        var cancelTouchCancel = this.gridsterItem.renderer.listenGlobal('document', 'touchcancel', cancelDrag);
...
GridsterResizable = __decorate([
    core_1.Injectable(),
    __metadata("design:paramtypes", [gridsterItem_component_1.GridsterItemComponent, gridster_component_1.GridsterComponent])
], GridsterResizable);
